...
public class MainView extends VerticalLayout {
    ...
    public MainView() {
        ...
        if (todayFile != null && todayFile.exists()) {
            ...
            consoleOutput.setValue("> All datasets generated by this web application are licensed under the Creative Commons Attribution 4.0 license (http://creativecommons.org/licenses/by/4.0). Any public use, publication, or official report MUST cite: \n"
    ...
    private VerticalLayout buildLicenseView() {
        ...
        String htmlContent = "<b>SOFTWARE LICENSE (GNU GPLv3):</b><br>"
                ...
                + "All datasets generated by this web application are licensed under the Creative Commons Attribution 4.0 license "
        ...
        try {
            if (pdfFiles != null && pdfFiles.length > 0) {
                ...
                if (rawFolder.exists() && simple2Folder.exists()) {
                    ...
                    logBuilder.append("All datasets generated by this web application are licensed under the Creative Commons Attribution 4.0 license (http://creativecommons.org/licenses/by/4.0). Any public use, publication, or official report MUST cite: ");
